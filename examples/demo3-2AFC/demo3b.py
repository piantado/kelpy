...
"""
	...
	This version differs from demo3a in that it intakes a csv file of image pairs instead of having the images hard coded into the program.
...
## And use this line to open the .csv file. This designates the .csv file to open, 'rb' means it's is opened in read mode, and we name the file object 'f'.
...
## these are the lines we replaced from the other demo3, just for reference:
